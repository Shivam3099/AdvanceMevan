...
@WebServlet(urlPatterns = "/ModifyCtl")
public class ModifyCtl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = req.getRequestDispatcher("ModifyInsert.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (bean != null) {
				...
				RequestDispatcher rd = req.getRequestDispatcher("StudentMgtViwe.jsp");
				rd.forward(req, resp);
